const TRANSLATIONS = {
  he: {
    ...
    strings: {
      ...
      'gallery.imageAlt': 'צנצנת דבש זמרת הארץ',
      ...
      'order.decreaseQty': 'הפחתת כמות',
      'order.increaseQty': 'הוספת כמות',
  ...
  en: {
    ...
    strings: {
      ...
      'gallery.imageAlt': 'Zimrat HaAretz honey jar',
  ...
  fr: {
    ...
    strings: {
      ...
      'gallery.imageAlt': 'Pot de miel Zimrat HaAretz',
      ...
      'order.decreaseQty': 'Diminuer la quantité',
      'order.increaseQty': 'Augmenter la quantité',
